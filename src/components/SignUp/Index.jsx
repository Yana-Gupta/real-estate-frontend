                        ...
                        <form action="" method="get">
                            ...
                            <Grid spacing={2} container>
                                <Grid xxs={12} xs={12} sm={4} md={4} item>
                                    <TextField type={'text'} variant="filled" label="First Name" required fullWidth />
                                </Grid>
                                <Grid xxs={12} xs={4} sm={4} md={4} item>
                                    <TextField type={'text'} variant="filled" label="Middle Name" fullWidth />
                                </Grid>
                                <Grid xxs={12} xs={8} sm={4} md={4} item>
                                    <TextField type={'text'} variant="filled" label="Last Name" required fullWidth />
                                </Grid>
                                ...
                                <Grid xxs={12} xs={12} sm={6} md={6} item>
                                    <TextField type={'password'} label='Create a password' fullWidth />
                                </Grid>
                                <Grid xxs={12} xs={12} sm={6} md={6} item>
                                    <TextField type={'password'} label='Re-Enter password' fullWidth />
                                </Grid>
                                <Grid xxs={12} xs={12} sm={12} md={12} item>
                                ...
                                <Grid xxs={12} xs={12} sm={12} md={12} item alignItems={'center'}>
